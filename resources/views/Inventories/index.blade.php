  ...
  <div class="py-6">
    <div class=" mx-auto sm:px-6 lg:px-8">
      <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
        <div class="container py-2" class="col-md-12">
          <div class="row " >
            <div class="col-md-4"></div>
            <div class="col-md-4">
              <a title="Create" href="{{ route('inventories.create') }}" class="sombra btn btn-success mx-auto">{{ __('Add product') }}</a>
            </div>
              ...
              <div class="table-responsive">
                ...
                @else
                  <table class="table table-striped table-sm table-hover caption-top">
                    <caption>{{ __('List of inventories') .": ".$count}}</caption>
                    <thead>
                      <tr>
                        <th scope="col">#</th>
                        ...
                        <tr>
                          ...
                          <td>
                            <div class="btn-group" role="group" aria-label="Basic example">
                              <a title="Show" href="{{ route('inventories.show', $product) }}" class="sombra btn btn-primary btn-sm">{{ __('See') }}</a>
                              <a title="Edit" href="{{ route('inventories.edit', $product) }}" class="sombra btn btn-info btn-sm">{{ __('Edit') }}</a>
                              <a title="Delete" href="#deleteModal{{ $product->id }}" class="sombra btn btn-danger btn-sm" data-bs-toggle="modal">{{ __('Delete') }}</a>
                            </div>
                          </td>
                        </tr>
                        <?php $i += 1; ?>
        ...
        <div class="container mb-3"class="col-md-12">
          <div class="row">
            <div class="col-md-12">
