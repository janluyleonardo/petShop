<div class="p-6 sm:px-20 bg-white border-b border-gray-200">
    ...
    <div class="mt-8 text-2xl">
        Welcome to your Universal ML pet shop application!
    </div>

    <div class="mt-6 text-gray-500">
        Universal ML provides a beautiful, robust starting point for your next Laravel application. Laravel is designed
